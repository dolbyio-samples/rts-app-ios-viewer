...
/**
 * @brief Call this to provide your own CVPixelBuffer.
 * @remark This API does not copy the CVPixelBuffer if using H264 which is a hardware accelerated encoder.
 * @remark If using codecs other than H264, an internal copy of the frame will occur. 
 * @param pixelBuffer a CVPixelBufferRef. Note: This reference will be retained and disposed of internally.
 */
 ...
 * @remark If using codecs other than H264, an internal copy of the frame will occur. 
 * @param pixelBuffer a CVPixelBufferRef. Note: This reference will be retained and disposed of internally.
 * @param timestamp attach a timestamp to the given frame.
 */
